...
export default function Testimonials() {
  return (
    <section className="py-24 bg-[#FFF8E7] overflow-hidden" aria-labelledby="testimonials-heading">
      <div className="container mx-auto px-6 md:px-12">
        <header className="text-center mb-16">
          <span className="text-[#C9A646] font-medium tracking-wider uppercase text-sm">Trusted by Clients</span>
          <h2 id="testimonials-heading" className="text-4xl md:text-5xl font-heading font-bold text-[#1F3D2B] mt-2 mb-4">Love Stories & Happy Clients</h2>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="text-4xl text-[#C9A646] absolute top-6 right-8 font-serif opacity-30" aria-hidden="true">"</div>
              <div className="flex text-[#C9A646] mb-4" aria-label="5 star rating">
                {[...Array(5)].map((_, i) => (
              ...
              <blockquote className="text-gray-600 mb-6 italic leading-relaxed text-sm">
                "{testimonial.text}"
              </blockquote>
              <footer>
